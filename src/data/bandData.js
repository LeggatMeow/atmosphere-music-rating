...
export const bandData = {
  ...
  albums: [
    ...
    { ...overcastTracks, id: overcastTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Underground Hip-Hop" },
    { ...godLovesUglyTracks, id: godLovesUglyTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Alternative Hip-Hop" },
    { ...sevensTravelsTracks, id: sevensTravelsTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Alternative Hip-Hop" },
    { ...youCantImagineTracks, id: youCantImagineTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
    { ...whenLifeGivesYouLemonsTracks, id: whenLifeGivesYouLemonsTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Alternative Hip-Hop" },
    { ...theFamilySignTracks, id: theFamilySignTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Alternative Hip-Hop" },
    { ...southsidersTracks, id: southsidersTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
    { ...fishingBluesTracks, id: fishingBluesTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
    { ...miVidaLocalTracks, id: miVidaLocalTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Alternative Hip-Hop" },
    { ...wheneverTracks, id: wheneverTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Alternative Hip-Hop" },
    { ...theDayBeforeHalloweenTracks, id: theDayBeforeHalloweenTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
    { ...wordTracks, id: wordTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
    { ...soManyOtherRealitiesTracks, id: soManyOtherRealitiesTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
    { ...jesturesTracks, id: jesturesTracks.albumId, type: "studio", artist: "Atmosphere", genre: "Hip-Hop" },
